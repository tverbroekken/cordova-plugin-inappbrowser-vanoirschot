...
- (void)createViews
{
	...
	self.toolbar.backgroundColor = [UIColor colorWithRed:231.0 / 255.0 green:65.0 / 255.0 blue:45.0 / 255.0 alpha:1];
	self.toolbar.tintColor = [UIColor colorWithRed:231.0 / 255.0 green:65.0 / 255.0 blue:45.0 / 255.0 alpha:1];
